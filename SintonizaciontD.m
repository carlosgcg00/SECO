...
axis([0 1 0 1.5])
legend({'\tau_{D1} = 0.01', '\tau_{D1} = 0.1','M_p \leq 1.14', 'M_p \geq 1.05', 't_s \leq 0.45', 't_p \leq 0.25'},'Location','southeast')

title('Buscamos \tau_{D1}, K_P = 5, \tau_I = 0.1')
saveas(f2,'Sintonizacion/Valores_tD.png')